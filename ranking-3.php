...
<?php
    ...
    include "Untitled-4.php";
      $a=(int)$_SESSION['id'];
        ...
        $sql1 = "SELECT * FROM ranking WHERE id=$a";
...
<body class="bg-secondary text-white">
  ...
  <div style="height: 100px"></div>
          ...
          <div class="card-header bg-white">
            <h3 class="mb-0"><i class="far fa-clone pr-1"></i><p style="color:black">Employee Information</p></h3>
          </div>
          <div class="card-body bg-white">
            <table class="table table-bordered">
              ...
              <tr>
                <th width="30%">Score out of 10</th>
                <td width="2%">:</td>
                <td><?=$row1['rank']?></td>
              </tr>
