...
<body class="bg-secondary text-white">
    ...
    style="min-height: 80vh ">
        ...
        action="attendance-2.php"
        method="post"
        style="width: 650px;">
        <h2 class="text-center p-3"><p style="color:black ">Mark Attendance</p></h2>
        <?php if(isset($_GET['error'])) {?>
            ...
            <div class="mb-3">
                <label for="a_date" class="form-label"><h6><p style="color:black ">Date</p></h6></label>
                <input type="date" class="form-control" name="a_date" id="a_date">
            </div>
            <button type="submit" class="btn btn-dark">Mark Attendance</button><br><br>
        </form>
    </div>
</body>
</html>