...
<body>
<div class="jumbotron jumbotron-fluid bg-secondary" style="background: url('https://images.pexels.com/photos/5863359/pexels-photo-5863359.jpeg?cs=srgb&dl=pexels-nataliya-vaitkevich-5863359.jpg&fm=jpg')">
  <div class="container text-white">
    <h2>Hey <?=$_SESSION['name']?>! Welcome to the Employee Page.</h2>     
    <p>Consistency is key, but on a side note - weekends cannot get here faster. Binge-watched Squid Game?</p>
    <div class="container">
  ...
  <div class="card-columns">
    <div class="card bg-light">
      <div class="card-body text-center">
        <img src="https://st.depositphotos.com/1265075/2916/i/600/depositphotos_29165825-stock-photo-website-contact-us-icons-on.jpg" style="width:300px;height:170px;"><br><br>
        <button type="button" onclick="location.href = 'profile.php';"  class="btn btn-outline-dark">Profile</button>
      </div>
    </div><br><br>
    <div class="card bg-light">
      <div class="card-body text-center">
        ...
        <button type="button" onclick="location.href = 'payslip-3.php';" class="btn btn-outline-dark">Pay Slip</button>
      </div>
    </div>
    <div class="card bg-light">
      <div class="card-body text-center">
        ...
        <button type="button" onclick="location.href = 'ranking-3.php';" class="btn btn-outline-dark">Ranking</button>
      </div>
    </div><br><br>
    <div class="card bg-light">
      <div class="card-body text-center">
        ...
        <button type="button" onclick="location.href = 'attendance-3.php';" class="btn btn-outline-dark">Attendance</button>
      </div>
    </div> 
    <div class="card bg-light">
      <div class="card-body text-center">
        ...
        <button type="button" onclick="location.href = 'announcement-3.php';" class="btn btn-outline-dark">Announcements</button>
      </div>
    </div><br><br>
    <div class="card bg-light">
      <div class="card-body text-center">
        ...
        <button type="button" onclick="location.href = 'feedback-1.php';" class="btn btn-outline-dark">Feedback</button>
      </div>
    </div> 
  </div>
</div>
